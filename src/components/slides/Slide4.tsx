import { MapPin, AlertCircle, UserX } from 'lucide-react';
...
export function Slide4() {
  ...
  const limitations = [
    { icon: MapPin, text: 'No location-based matching between donors and patients' },
    { icon: AlertCircle, text: 'No smart prioritization system for emergency cases' },
    { icon: UserX, text: 'Weak donor engagement and motivation mechanisms' }
  ];
